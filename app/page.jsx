  ...
  return (
    <div className="flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-6">Welcome to DaisyUI Crash Course</h1>
        <div className="mb-4">
        ...
        <div className="mb-4">
          ...
          <div className="alert alert-success mb-2">Success Alert</div>
        ...
        <div className="mb-4">
          <p className="text-gray-600 mb-2">Badges:</p>
